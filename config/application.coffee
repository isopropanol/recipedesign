...
steroids.config.name = "recipe"

# ## Start Location
# steroids.config.location = "http://localhost/views/recipe/create.html"
...
steroids.config.tabBar.tabs = [
  ...
  {
    title: "People"
    icon: "icons/person-add@2x.png"
    location: "http://localhost/views/recipe/follow.html"
  },
  {
    title: "Create"
    icon: "icons/camera@2x.png"
    location: "http://localhost/views/recipe/create.html"
  },
  {
    title: "Profile"
    icon: "icons/person@2x.png"
    location: "http://localhost/views/recipe/profile.html"
  }
]

steroids.config.tabBar.tintColor = "#000000"
steroids.config.tabBar.tabTitleColor = "#888888"
steroids.config.tabBar.selectedTabTintColor = "#ffffff"
steroids.config.tabBar.selectedTabBackgroundImage = "icons/nothing@2x.png"
